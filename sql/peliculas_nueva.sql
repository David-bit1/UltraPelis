-- Crear peliculas_nueva con servidores inline
...
create policy "Public read peliculas_nueva" on public.peliculas_nueva for select using (true);
create policy "Auth insert peliculas_nueva" on public.peliculas_nueva for insert with check (auth.role() = 'authenticated');
create policy "Auth update peliculas_nueva" on public.peliculas_nueva for update using (auth.role() = 'authenticated');
create policy "Auth delete peliculas_nueva" on public.peliculas_nueva for delete using (auth.role() = 'authenticated');